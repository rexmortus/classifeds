...
class AdvertisementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post advertisements_url, params: { advertisement: { body: @advertisement.body, published: @advertisement.published, title: @advertisement.title } }
    end
  ...
  test "should update advertisement" do
    patch advertisement_url(@advertisement), params: { advertisement: { body: @advertisement.body, published: @advertisement.published, title: @advertisement.title } }
